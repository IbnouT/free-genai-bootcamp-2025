...
from app.models import Word, Group, WordGroup, StudyActivity, StudySession, WordReviewItem
...
def test_word_group_relationship(db_session):
    word = Word(script="食べる", meaning="to eat")
