...
Revision ID: a10ccf203e5f
Revises: 
Create Date: 2025-02-17 22:17:28.074621
...
def upgrade() -> None:
    ...
    sa.Column('is_language_specific', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_study_activities_id'), 'study_activities', ['id'], unique=False)
    op.create_table('activity_language_support',
    sa.Column('activity_id', sa.Integer(), nullable=False),
    sa.Column('language_code', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['activity_id'], ['study_activities.id'], ),
    sa.ForeignKeyConstraint(['language_code'], ['languages.code'], ),
    sa.PrimaryKeyConstraint('activity_id', 'language_code')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('activity_language_support')
